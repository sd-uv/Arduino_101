...
/* 
	...
	Load myUnoDevs_SampleDevices.txt before running
	...
	Double-click (or right-click) on the Serial (SERIAL) I/O device to 
	see an expanded view of its received ( println()'d) characters.
	...
	Drag the main toolbar's I/O Values Scaler slider control to
	change the pulse width on the PULSER's pin 6 (which drives
	the DC motor's PWM pin, and so controls its speed)
*/
